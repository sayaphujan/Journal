			...
			<div class="header">
				<div class="jimgMenu">
				  <ul>
					...
					<li class="people"><a href="main.php?v=listAll">Jurnal</a></li>
					<li class="nature"><a href="main.php?v=links">Links</a></li>
					<li class="abstract"><a href="main.php?v=hasilAll">Polling</a></li>
					<li class="corporate"><a href="main.php">Home</a></li>
				  </ul>
				</div>
			</div>
		</div>
